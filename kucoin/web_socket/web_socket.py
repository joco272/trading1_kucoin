...
class WebSocket():
    ...
    def on_close(self, ws):
        ...
        print('df shape: ', self.anlsys.df_ticker.shape)
        return
    ...
    def process_ticker(self, msg):
        ...
        message = pd.DataFrame({'sequence': [int(sequence)], 'time': [time_stamp], 'price': [float(price)]})
        self.anlsys.merge_ticker(message)
        # print(message)
